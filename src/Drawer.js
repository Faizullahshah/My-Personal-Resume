  ...
  render() {
    return (
      <View style={{ flex: 1, backgroundColor:'aquamarine', paddingLeft:10 }}>
        ...
        <Text>Phone Number: 0331-8005482</Text>

        <Text>Father Name: SYED ABDULLAH SHAH (Late)</Text>
...
class ExperienceScreen extends React.Component {
  ...
  render() {
    return (
      ...
      <Text style={{fontWeight:'bold'}}>IT system Support Engineer:</Text>  {'\n'}
      - 19th June 2018 - Still Working (NCR-CET College)  {'\n'}
      ...
      - 1st April 2019 - Still Working (Progmatic.pk)  {'\n'}
      - Mobile App Developer And UI Dresigner  {'\n'}
